...
7. For real-time websocket data, set `VITE_WS_BASE_URL` to your backend websocket origin (for example `wss://api.yourdomain.com`).
8. Install/authorize the **Vercel for GitHub** app so PR preview comments/checks are posted.
